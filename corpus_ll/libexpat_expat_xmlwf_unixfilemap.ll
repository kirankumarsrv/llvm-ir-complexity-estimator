; ModuleID = 'corpus_src/libexpat/expat/xmlwf/unixfilemap.c'
source_filename = "corpus_src/libexpat/expat/xmlwf/unixfilemap.c"
...
define dso_local noundef i32 @filemap(ptr noundef %0, ptr nocapture noundef readonly %1, ptr noundef %2) local_unnamed_addr #0 {
  ...
  %5 = tail call i32 (ptr, i32, ...) @open(ptr noundef %0, i32 noundef 0) #7
  %6 = icmp slt i32 %5, 0
  br i1 %6, label %7, label %8

7:                                                ; preds = %3
  tail call void @perror(ptr noundef %0) #8
  br label %40

8:                                                ; preds = %3
  %9 = call i32 @fstat(i32 noundef %5, ptr noundef nonnull %4) #7
  %10 = icmp slt i32 %9, 0
  br i1 %10, label %11, label %13

11:                                               ; preds = %8
  tail call void @perror(ptr noundef %0) #8
  %12 = tail call i32 @close(i32 noundef %5) #7
  br label %40
...
18:                                               ; preds = %13
  %19 = tail call i32 @close(i32 noundef %5) #7
  %20 = load ptr, ptr @stderr, align 8, !tbaa !12
  %21 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str, ptr noundef %0) #8
  br label %40
...
26:                                               ; preds = %22
  %27 = tail call i32 @close(i32 noundef %5) #7
  br label %40
...
30:                                               ; preds = %28
  tail call void %1(ptr noundef nonnull @filemap.c, i64 noundef 0, ptr noundef %0, ptr noundef %2) #7
  %31 = tail call i32 @close(i32 noundef %5) #7
  br label %40

32:                                               ; preds = %28
  %33 = tail call ptr @mmap(ptr noundef null, i64 noundef %24, i32 noundef 1, i32 noundef 2, i32 noundef %5, i64 noundef 0) #7
  %34 = icmp eq ptr %33, inttoptr (i64 -1 to ptr)
  br i1 %34, label %35, label %37

35:                                               ; preds = %32
  tail call void @perror(ptr noundef %0) #8
  %36 = tail call i32 @close(i32 noundef %5) #7
  br label %40

37:                                               ; preds = %32
  tail call void %1(ptr noundef %33, i64 noundef %24, ptr noundef %0, ptr noundef %2) #7
  %38 = tail call i32 @munmap(ptr noundef %33, i64 noundef %24) #7
  %39 = tail call i32 @close(i32 noundef %5) #7
  br label %40

40:                                               ; preds = %37, %35, %30, %26, %18, %11, %7
  %41 = phi i32 [ 0, %7 ], [ 0, %11 ], [ 2, %26 ], [ 1, %30 ], [ 0, %35 ], [ 1, %37 ], [ 0, %18 ]
