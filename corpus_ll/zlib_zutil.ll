; ModuleID = 'corpus_src/zlib/zutil.c'
source_filename = "corpus_src/zlib/zutil.c"
...
define dso_local ptr @zError(i32 noundef %0) local_unnamed_addr #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [10 x ptr], ptr @z_errmsg, i64 0, i64 %6
  %8 = load ptr, ptr %7, align 8, !tbaa !5
  ret ptr %8
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(inaccessiblemem: readwrite) uwtable
define dso_local noalias noundef ptr @zcalloc(ptr nocapture noundef readnone %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #1 {
  %4 = mul i32 %2, %1
  %5 = zext i32 %4 to i64
